...
if(endDate === null){
  latestDateAproval = true
      ...
      return (
         cityAproval&&
        interestMet && earliestDateAproval && latestDateAproval
      );
  ...
  return (
    <>
      ...
      <h2 style={{ marginRight: "40px" }}>Filter by</h2>
          <h3>Theme:</h3>
          <button id="see-interest-discover-page"onClick={seeOptions}>Choose themes ▼</button>
      ...
      {allEvents &&
        ...
        allFilteredPersons.map((eachEvent) => {
          ...
          return (
            ...
            <div   >
              <img
                src={eachEvent.profile_image_url}
                alt={`Profile image of ${eachEvent.name}`}
              />
